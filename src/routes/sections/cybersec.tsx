...
export const Route = createFileRoute('/sections/cybersec')({
...
function RouteComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center px-4 bg-background">
      <div className="max-w-md space-y-3 border border-border/40 bg-card/40 p-6 rounded-xl backdrop-blur-sm">
