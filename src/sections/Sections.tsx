  ...
  return (
    <div className={'bg-white'}>
      <div className={'flex items-center h-[50vh] w-7/8 m-auto text-lg'}>
        <div
          className={'flex flex-col *:m-8 justify-center w-1/4'}
          id={'SEKCJE'}
        >
          {SECTION_DATA.map((section_data, i) => (
            <div
              key={section_data[0]}
              className={'cursor-pointer flex section-title items-center'}
              onClick={() => {
                setSectionID(() => i);
            ...
            >
              <img
                srcSet={section_data[2]}
                alt={section_data[0] + ' logo'}
                className={'mr-5 size-18'}
              />
        ...
        <div
          className={'flex items-center text-justify w-3/4 justify-center'}
          ref={SectionDescRef}
        >
